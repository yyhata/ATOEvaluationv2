...
<div id="header" class="container">
	<div id="logo">
		<h1><a href="Login-noJS.jsp">Demo Bank</a>　<font size ="2" color="black">　　Javascriptなし　　</font></h1>
	</div>
	<div id="menu">
		<ul>
...
<div id="page-wrapper">
	<div id="page" class="container">
		<div class="pboxA">
			...
			<a href="ChangeProfile-noJS.jsp" class="button">登録プロフィール確認</a>
		</div>
		<div class="pboxB">
			<h3>お振り込み</h3>
			<p>こちらから自行・他行宛のお振込みが可能です。<br>Schedule Transfer</p>
			<a href="Transfer-noJS.jsp" class="button">お振込み</a>
		</div>
	</div>
</div>
<div id="copyright">
